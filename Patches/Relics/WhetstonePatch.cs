...
namespace StatTheRelics.Patches.Relics {
    ...
    public static class WhetstonePatch {
        ...
        static void Prefix(Whetstone __instance, ref object __state) {
            try {
        ...
        static void Postfix(Whetstone __instance, object __state) {
            try {
        ...
        static State CaptureDeck(Whetstone relic) {
            var state = new State();
        ...
        static int CountUpgraded(Whetstone relic, State state) {
            var count = 0;

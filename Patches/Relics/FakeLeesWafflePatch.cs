...
namespace StatTheRelics.Patches.Relics {
    ...
    public static class FakeLeesWafflePatch {
        ...
        static void Prefix(FakeLeesWaffle __instance, ref object __state) {
            try {
        ...
        static void Postfix(FakeLeesWaffle __instance, Task __result, object __state) {
            try {
        ...
        static void Count(FakeLeesWaffle relic, HpState state) {
            try {
